 ...
 * =========================LICENSE_END==================================
 */
package org.flywaydb.database.gbase8s;
...
public class Gbase8sSchema extends Schema<Gbase8sDatabase, Gbase8sTable> {
    ...
    protected void doClean() throws SQLException {
        List<String> procedures = jdbcTemplate.queryForStringList("SELECT t.procname FROM sysprocedures AS t" +
        ...
        List<String> sequences = jdbcTemplate.queryForStringList("SELECT t.tabname FROM systables AS t" +
    ...
    protected Gbase8sTable[] doAllTables() throws SQLException {
        return findTables("SELECT t.tabname FROM systables AS t" +
